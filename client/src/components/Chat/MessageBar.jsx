...
function MessageBar() {
  ...
  return (
    <div className="bg-panel-header-background h-20 px-4 flex relative items-center gap-6">
      {
        !showAudioRecorder && (
          <>
            ...
            <div className="w-full rounded-lg h-10 flex items-center">
              <input
                ...
                className="text-sm bg-input-background focus:outline-none text-white h10 rounded-lg px-5 py-4 w-full"
