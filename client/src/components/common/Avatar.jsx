        ...
        }
        {
          type === "xl" && (
            <div className="relative cursor-pointer z-0"
              ...
              <div className={`z-10 h-60 w-60 absolute top-0 left-0 flex items-center rounded-full justify-center flex-col text-center gap-2 bg-photopicker-overlay-background
          ${hover ? "visible" : "hidden"}`}
                onClick={(e) => showContextMenu(e)}
              >
                <FaCamera className="text-2xl" id="open-context" onClick={(e) => showContextMenu(e)} />
